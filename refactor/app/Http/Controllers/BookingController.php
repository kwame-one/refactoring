...
class BookingController extends Controller
{
     ...
     * @param BookingServiceInterface $service
     */
    public function __construct(BookingServiceInterface $service)
    {
    ...
    public function getHistory(Request $request)
    {
        if($user_id = $request->get('user_id')) {
            ...
            $response = $this->service->getUsersJobsHistory($user_id, $request->all());
            return response($response);
        }
    ...
    {
        $data = $request->all();
        $job = $this->service->find($data['jobid']);
        $job_data = $this->service->jobToData($job);
        $this->service->sendNotificationTranslator($job, $job_data, '*');
    ...
    public function resendSMSNotifications(Request $request)
    {
        ...
        try {
            $this->service->sendSMSNotificationToTranslator($job);
